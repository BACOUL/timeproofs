...
const batchDefinitions = [
  ["ARB-COM-001", "Publish Community CLI and immutable release", ["AR-COM-006"], { status: "IN_REVIEW", owner: "CODEX_AND_JEASON", spec_status: "EXECUTION_READY", pr_number: 124, evidence: [{ type: "publication_release_execution", pr: 124, npm_publication: "SUCCESS", package: "@timeproofs/agentready", version: "0.1.0-alpha.0", alpha_dist_tag: "0.1.0-alpha.0", unexpected_latest_dist_tag: "0.1.0-alpha.0", latest_removal_result: "E400", owner_decision: "ACCEPT_TEMPORARILY", latest_temporarily_accepted_until: "first stable release", future_prereleases_dist_tag: "alpha", git_tag_created: true, git_tag: "v0.1.0-alpha.0", git_tag_target: "150da23932c1fb9433cb3d546904f03c18c909e9", remote_tag_verified: true, github_release_created: true, github_release_url: "https://github.com/BACOUL/timeproofs/releases/tag/v0.1.0-alpha.0", github_release_prerelease: true, github_release_latest: false, release_notes_match_validated_file: true, new_npm_operation_authorized: false, new_npm_operation_executed: false }], notes: "npm publication succeeded with a documented latest exception accepted temporarily by JEASON. The immutable Git tag and GitHub prerelease now exist and point to the approved source commit. PR #124 is in review to merge the release evidence; no new npm operation is authorized.", scope_justification: "Atomic release boundary after owner, legal and private 2FA checkpoint approval." }],
