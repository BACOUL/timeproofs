...
const milestones = [
  ...
  ["M3", "Community publicly usable", "PLANNED", "BEFORE_COMMUNITY_PUBLICATION", ["npm package published", "immutable tag", "GitHub Release", "public installation tested", "public Action usable", "onboarding documented", "no signup", "no payment"], [["M3-NPM-PUBLISH", "npm package published", ["AR-COM-006"]], ["M3-TAG-RELEASE", "immutable tag and GitHub Release", ["AR-COM-006"]], ["M3-PUBLIC-INSTALL", "public installation tested", ["AR-COM-008"]], ["M3-ACTION", "public Action usable", ["AR-COM-007", "AR-COM-009"]], ["M3-ONBOARDING", "onboarding documented without signup or payment", ["AR-ONB-001", "AR-ONB-002", "AR-ONB-003", "AR-ONB-004"]]]],
  ["M4", "Engine benchmark established", "PLANNED", "BEFORE_PRO_TECHNICAL_COMPLETION", ["OpenAPI and MCP corpora", "human annotations", "benchmark acceptance thresholds frozen before final evaluation", "precision and recall", "false-positive and false-negative rates", "performance", "reproducibility", "AR001 AR003 AR008 AR010 treated or documented"], [["M4-CORPUS", "OpenAPI and MCP corpora and harness", ["AR-ENG-001"]], ["M4-HUMAN-LABELS", "human annotations validated", ["AR-ENG-001H"], true], ["M4-THRESHOLDS", "benchmark acceptance thresholds frozen before final evaluation", ["AR-ENG-001T"], true], ["M4-METRICS", "precision recall false positive and false negative rates", ["AR-ENG-002"]], ["M4-AR-FIXES", "AR001 AR003 AR008 AR010 treated or documented", ["AR-ENG-003"]], ["M4-PERFORMANCE", "performance and reproducibility", ["AR-ENG-004", "AR-ENG-005"]]]],
...
for (const [id,title] of [["001","Add local scan onboarding command"],["002","Add init workflow generator"],["003","Add demo command and fixtures"],["004","Publish three-minute tutorial"]]) codex("AR-ONB-EPIC", `AR-ONB-${id}`, "M3", "BEFORE_COMMUNITY_PUBLICATION", "ONB", title, { depends_on: id === "001" ? ["AR-COM-006"] : ["AR-ONB-001"], source_documents: [doc.onboarding, doc.cli], branch: slug(title), pr_title: `feat(community): ${title.toLowerCase()}`, allowed_paths: ["cli/**", "agentready-examples/**", "docs/agentready/**"], forbidden_paths: ["agentready-core/**", "package.json", "LICENSE", "*.html"], required_commands: ["node cli/tests/run-agentready-cli-tests.mjs"] });

epic("AR-ENG-EPIC", "M4", "BEFORE_PRO_TECHNICAL_COMPLETION", "ENG", "Engine benchmark and quality", ["AR-COM-008"]);
codex("AR-ENG-EPIC", "AR-ENG-001", "M4", "BEFORE_PRO_TECHNICAL_COMPLETION", "ENG", "Add benchmark corpus architecture and annotation schema", { depends_on: ["AR-COM-008"], source_documents: [doc.engine, doc.commercial], branch: "test-engine-benchmark-corpus-harness", pr_title: "test(engine): add AgentReady benchmark corpus foundation", allowed_paths: ["agentready-core/**", "agentready-examples/**", "docs/agentready/**"], forbidden_paths: ["package.json", "LICENSE", "*.html"], required_commands: ["node agentready-core/tests/run-agentready-core-tests.mjs"] });
...
for (const row of [["AR-ENG-002","Add benchmark metric calculation"],["AR-ENG-003","Correct AR001 AR003 AR008 and AR010 semantics"],["AR-ENG-004","Add performance and reproducibility benchmark"],["AR-ENG-005","Publish reproducible benchmark report and limitations"],["AR-ENG-006","Prepare voluntary false-positive reporting command"]]) codex("AR-ENG-EPIC", row[0], row[0] === "AR-ENG-006" ? "M5" : "M4", "BEFORE_PRO_TECHNICAL_COMPLETION", "ENG", row[1], { weight: row[0] === "AR-ENG-003" ? 5 : 3, depends_on: row[0] === "AR-ENG-002" ? ["AR-ENG-001H", "AR-ENG-001T"] : row[0] === "AR-ENG-005" ? ["AR-ENG-001H", "AR-ENG-001T", "AR-ENG-002", "AR-ENG-003", "AR-ENG-004"] : ["AR-ENG-002"], source_documents: [doc.engine, doc.rules], branch: slug(row[1]), pr_title: `${row[0] === "AR-ENG-003" ? "fix" : row[0] === "AR-ENG-006" ? "feat" : "test"}(engine): ${row[1].toLowerCase()}`, allowed_paths: ["agentready-core/**", "scripts/**", "docs/agentready/**"], forbidden_paths: ["package.json", "LICENSE", "*.html"], required_commands: ["node agentready-core/tests/run-agentready-core-tests.mjs"], scope_justification: row[0] === "AR-ENG-003" ? "Weight 5 justified: strongly coupled rule semantics correction across four known rule gaps." : undefined });

epic("AR-PRO-EPIC", "M5", "BEFORE_PRO_TECHNICAL_COMPLETION", "PRO", "Pro MVP", ["AR-ENG-005"]);
[
