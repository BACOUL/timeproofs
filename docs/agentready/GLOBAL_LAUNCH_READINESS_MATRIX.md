...
| Licenses | Automatic license after payment | Not implemented | License generated after checkout | yes | Engineering | `LICENSE_AND_ENTITLEMENT_ARCHITECTURE.md` | PLANNED |
| Entitlements | Plan feature gates | Not implemented | Entitlement object enforced | yes | Engineering | `PRICING_AND_ENTITLEMENTS_V0_1.md` | PLANNED |
| Billing | Stripe Checkout and subscriptions | Not implemented | Test-mode checkout, portal, invoices | yes | Engineering/Ops | `AUTOMATED_PURCHASE_AND_BILLING_FLOW.md` | PLANNED |
| Account | Customer and organization account | Not implemented | Automatic account/org creation | yes | Engineering | Future account docs/code | NOT_STARTED |
...
| Pricing | Self-service plan model | Documented in this PR | Display only implemented plans | yes | Product | Business model and entitlements docs | IN_PROGRESS |
...
Real paid checkout must remain disabled until every `Blocking launch = yes` item is `READY`.
