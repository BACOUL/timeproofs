...
| ARB-SITE-GLOBAL-003 | batch | CODEX_AND_JEASON | READY | Publish AgentReady standard rules and governance foundation | source inventory for AgentReady definition AR001-AR010 severity scoring status versioning governance and reference implementation behavior<br>conflict and stale-source register with acceptance requirements rather than guessed resolutions<br>route map and information architecture for standard rules JSON examples resources and sample-report surfaces<br>AR001 through AR010 mapping table to finding codes severity categories and current implementation coverage<br>example provenance with fixture path command output and reproduction notes for every displayed score finding or JSON excerpt<br>normative versus explanatory content review<br>limitation and no-certification claim audit<br>CTA and internal-link report<br>desktop and mobile screenshots for every primary standard surface<br>keyboard accessibility report<br>no-JavaScript evidence<br>320px overflow evidence<br>complete stacked preview URL<br>validator and deterministic regeneration results |
