...
| AR-COM-005 | task | JEASON | OWNER_ACTION_REQUIRED | Approve final Community tarball content | approved corrected tarball SHA-256<br>approved corrected source commit<br>owner approval confirming npm dist-tag alpha |
