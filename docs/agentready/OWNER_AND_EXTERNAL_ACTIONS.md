...
| ARB-COM-002 | batch | CODEX_AND_JEASON | READY | Publish public GitHub Action distribution | root metadata audit<br>reference migration inventory<br>test and workflow evidence<br>approved implementation SHA<br>immutable Action tag target<br>GitHub prerelease URL<br>Marketplace URL<br>public tag workflow run<br>full-SHA example<br>permissions and supply-chain review<br>site alignment report<br>rollback procedure |
