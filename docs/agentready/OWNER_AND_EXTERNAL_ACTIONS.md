...
| ARB-SITE-GLOBAL-002 | batch | CODEX_AND_JEASON | BLOCKED | Publish global product scanners CI and planned pricing foundation | desktop and mobile screenshots for every primary page<br>real output provenance<br>pricing source mapping<br>CTA and link report<br>no-JavaScript evidence<br>combined preview URL |
