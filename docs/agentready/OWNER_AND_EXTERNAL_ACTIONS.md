...
| AR-SITE-PREMIUM-EPIC | task | CODEX_AND_JEASON | PLANNED | Global standard public site before external validation | child tasks tracked in ledger |
| AR-SITE-PREMIUM-001 | task | CODEX_AND_JEASON | IN_REVIEW | Build global site shell navigation and footer | page and shell migration inventory<br>desktop navigation screenshots<br>mobile closed and open navigation screenshots<br>keyboard and focus test matrix<br>link validation report<br>320px no-overflow evidence<br>reduced-motion and no-JS evidence<br>shared asset inventory and size summary<br>owner visual review before merge |
| AR-SITE-GLOBAL-002 | task | CODEX_AND_JEASON | IN_REVIEW | Publish global product scanners CI and planned pricing foundation | desktop and mobile screenshots for every primary page<br>real output provenance<br>pricing source mapping<br>CTA and link report<br>no-JavaScript evidence<br>combined preview URL |
| AR-SITE-GLOBAL-003 | task | CODEX_AND_JEASON | IN_REVIEW | Publish AgentReady standard rules and governance foundation | source inventory for AgentReady definition AR001-AR010 severity scoring status versioning governance and reference implementation behavior<br>conflict and stale-source register with acceptance requirements rather than guessed resolutions<br>route map and information architecture for standard rules JSON examples resources and sample-report surfaces<br>AR001 through AR010 mapping table to finding codes severity categories and current implementation coverage<br>example provenance with fixture path command output and reproduction notes for every displayed score finding or JSON excerpt<br>normative versus explanatory content review<br>limitation and no-certification claim audit<br>CTA and internal-link report<br>desktop and mobile screenshots for every primary standard surface<br>keyboard accessibility report<br>no-JavaScript evidence<br>320px overflow evidence<br>complete stacked preview URL<br>validator and deterministic regeneration results |
...
| AR-BILL-001 | task | JEASON | OWNER_ACTION_REQUIRED | Verify Stripe bank tax and payment readiness | owner Stripe readiness evidence |
| AR-FIN-001 | task | JEASON | OWNER_ACTION_REQUIRED | Define accounting VAT and Stripe reconciliation workflow | owner accounting workflow decision |
| AR-SITE-EPIC | task | CODEX_AND_JEASON | PLANNED | Global product website and launch surfaces | child tasks tracked in ledger |
| AR-SEO-EPIC | task | CODEX_AND_JEASON | PLANNED | Technical SEO and content system | child tasks tracked in ledger |
| AR-SEO-004 | task | EXTERNAL_SPECIALIST | EXTERNAL_VERIFICATION_REQUIRED | Verify search topics and intent externally | Verify search topics and intent externally evidence |
| AR-SEO-013 | task | CODEX_AND_JEASON | RECURRING | Run recurring content update review | dated review evidence |
| AR-GEO-EPIC | task | CODEX_AND_JEASON | PLANNED | GEO and AI-first architecture | child tasks tracked in ledger |
| AR-COMP-EPIC | task | CODEX_AND_JEASON | PLANNED | Competitive intelligence and positioning | child tasks tracked in ledger |
| AR-COMP-001 | task | EXTERNAL_SPECIALIST | EXTERNAL_VERIFICATION_REQUIRED | Verify competitors and pricing categories | Verify competitors and pricing categories evidence |
| AR-COMP-007 | task | LEGAL | LEGAL_REVIEW_REQUIRED | Review public comparison claims | legal comparison review |
| AR-DOC-EPIC | task | CODEX_AND_JEASON | PLANNED | Documentation and developer experience | child tasks tracked in ledger |
| AR-INT-EPIC | task | CODEX_AND_JEASON | PLANNED | Framework integrations | child tasks tracked in ledger |
| AR-CAT-EPIC | task | CODEX_AND_JEASON | PLANNED | Standardization and category-building | child tasks tracked in ledger |
| AR-LEG-001 | task | LEGAL | LEGAL_REVIEW_REQUIRED | Finalize legal B2B terms privacy and liability | legal approval |
| AR-INFRA-EPIC | task | CODEX_AND_JEASON | PLANNED | Infrastructure and cloud | child tasks tracked in ledger |
| AR-SEC-001 | task | SECURITY | SECURITY_REVIEW_REQUIRED | Run security and supply-chain review | security review report |
| AR-SEC-004 | task | SECURITY | SECURITY_REVIEW_REQUIRED | Security signoff before first Pro sale | security signoff |
...
| ARB-COM-002 | batch | CODEX_AND_JEASON | DONE | Publish public GitHub Action distribution | root metadata audit<br>reference migration inventory<br>test and workflow evidence<br>approved implementation SHA<br>immutable Action tag target<br>GitHub prerelease URL<br>Marketplace URL<br>public tag workflow run<br>full-SHA example<br>permissions and supply-chain review<br>site alignment report<br>rollback procedure |
| ARB-SITE-PREMIUM-001 | batch | CODEX_AND_JEASON | IN_REVIEW | Build global site shell navigation and footer | page and shell migration inventory<br>desktop navigation screenshots<br>mobile closed and open navigation screenshots<br>keyboard and focus test matrix<br>link validation report<br>320px no-overflow evidence<br>reduced-motion and no-JS evidence<br>shared asset inventory and size summary<br>owner visual review before merge |
| ARB-SITE-GLOBAL-002 | batch | CODEX_AND_JEASON | IN_REVIEW | Publish global product scanners CI and planned pricing foundation | desktop and mobile screenshots for every primary page<br>real output provenance<br>pricing source mapping<br>CTA and link report<br>no-JavaScript evidence<br>combined preview URL |
| ARB-SITE-GLOBAL-003 | batch | CODEX_AND_JEASON | IN_REVIEW | Publish AgentReady standard rules and governance foundation | source inventory for AgentReady definition AR001-AR010 severity scoring status versioning governance and reference implementation behavior<br>conflict and stale-source register with acceptance requirements rather than guessed resolutions<br>route map and information architecture for standard rules JSON examples resources and sample-report surfaces<br>AR001 through AR010 mapping table to finding codes severity categories and current implementation coverage<br>example provenance with fixture path command output and reproduction notes for every displayed score finding or JSON excerpt<br>normative versus explanatory content review<br>limitation and no-certification claim audit<br>CTA and internal-link report<br>desktop and mobile screenshots for every primary standard surface<br>keyboard accessibility report<br>no-JavaScript evidence<br>320px overflow evidence<br>complete stacked preview URL<br>validator and deterministic regeneration results |
| ARB-SITE-GLOBAL-007 | batch | CODEX_AND_JEASON | PLANNED | Validate complete global standard site | Validate complete global standard site evidence |
