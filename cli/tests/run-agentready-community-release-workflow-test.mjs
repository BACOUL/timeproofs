...
assert.ok(workflow.includes("assert.equal(trustBatch?.status, 'READY')"));
...
assert.ok(workflow.includes("assert.equal(next?.batch?.id, 'ARB-SITE-GLOBAL-004')"));
...
assert.match(workflow, /Exact approved base head: 25636982cd944d3e947081740d5226f692c83741/);
