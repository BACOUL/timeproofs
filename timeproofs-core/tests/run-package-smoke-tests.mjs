...
for(const required of ['package.json','bin/timeproofs.js','sdk/index.js','sdk/enforcement.js','schemas/timeproofs-enforcement.v0.1.schema.json','adapters/ucp/checkout.js','adapters/ap2/payment-mandate.js','timeproofs-core/index.js','LICENSE']){
