...
for(const required of ['package.json','bin/timeproofs.js','sdk/index.js','adapters/ucp/checkout.js','adapters/ap2/payment-mandate.js','timeproofs-core/index.js','LICENSE']){
